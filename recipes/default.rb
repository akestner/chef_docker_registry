...
application "#{node['docker-registry'][:application_name]}" do
    ...
    Chef::Log.log :info,  "docker-registry/recipe/default.rb:: virtualenv_path => #{virtualenv_path}"
    Chef::Log.log :info,  "docker-registry/recipe/default.rb:: ENV['WORKON_HOME'] => #{ENV['WORKON_HOME']}"
    Chef::Log.log :info,  "docker-registry/recipe/default.rb:: directory => #{directory}"
    ...
    Chef::Log.log :info,  "docker-registry/recipe/default.rb:: node['docker-registry'][:working_dir] => #{node['docker-registry'][:working_dir]}"
    Chef::Log.log :info,  "docker-registry/recipe/default.rb:: gunicorn_working_dir => #{gunicorn_working_dir}"
    Chef::Log.log :info,  "docker-registry/recipe/default.rb:: gunicorn => #{gunicorn}"
